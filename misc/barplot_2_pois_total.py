...
br11 = np.arange(len(df["city"].unique())) + 0.15
...
total_count_pois = water_count_pois + tourism_count_pois + historic_count_pois + greenAreas_coint_pois
bar_width_ratio = 0.1
...
# Count pois
line_width = 20
bar_width_ratio = 0.01
greenAreas_count_pois_bar = ax.bar(br11, total_count_pois, edgecolor="blue")
# historic_ratio_bar = ax.bar(br22, historic_count_pois, bar_width_ratio,
#                                 linewidth=line_width,
#                                 color="dimgrey",
#                                 edgecolor="dimgrey",
#                                 label= "Historic Areas")
# tourism_ratio_bar = ax.bar(br33, tourism_count_pois, bar_width_ratio,
#                                 linewidth=line_width,
#                                 edgecolor="darkred",
#                                 color="darkred",
#                                 label= "Tourism Areas")
# water_ratio_bar = ax.bar(br4, water_count_pois, bar_width_ratio,
#                                 linewidth=line_width,
#                                 edgecolor="darkblue",
#                                 color="none",
#                                 label= "Water Areas")
...
ax.set_ylabel('Total count POIs')
